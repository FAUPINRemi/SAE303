        ...
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 text-white p-10 nav-underline">
            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu bg-dark bg-opacity-25 container dropdown-menu-end w-100">
                    <li><a class="dropdown-item text-white text-reset" href="index.php">Se déconnecter</a></li>
                    <li><hr class="dropdown-divider"></li>
                    <li><a class="dropdown-item text-white text-reset" href="reservationpageadmin.php">Admin réservations</a></li>
                </ul>
            </div>
        </ul>
    </div>
